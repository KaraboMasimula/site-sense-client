...
import { Eye, LockKeyhole, LucideAngularModule, Mail, User } from 'lucide-angular';
...
@Component({
  ...
  template: `
    <section class="pt-8">
      <h2 class="text-3xl font-bold text-slate-950">Create your account</h2>
      <p class="mt-2 text-base text-slate-500">Start improving your website today</p>
      ...
      <form class="mt-8 grid gap-5">
        <label class="grid gap-3 text-sm font-bold text-slate-950">
          ...
          <span class="relative">
            <span class="pointer-events-none absolute left-4 top-1/2 grid size-5 -translate-y-1/2 place-items-center text-slate-400">
              <lucide-icon [img]="UserIcon" class="block size-5" />
            </span>
            <input class="ss-input ss-input-with-icon min-h-14" placeholder="Jane Cooper" />
          </span>
        </label>
        ...
        <label class="grid gap-3 text-sm font-bold text-slate-950">
          ...
          <span class="relative">
            ...
            <input class="ss-input ss-input-with-icon ss-input-with-right-icon min-h-14" placeholder="Create a password" type="password" />
        ...
        <button class="ss-btn ss-btn-primary mt-4 min-h-14 w-full text-base" type="button">Create account</button>
      </form>
      ...
      <p class="mt-8 text-center text-sm text-slate-500">
        ...
        <a routerLink="/auth/login" class="font-bold text-violet-600">Sign in</a>
      </p>
    </section>
  `,
})
